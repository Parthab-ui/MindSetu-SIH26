...
3. **Voice ML Paralinguistic Biomarkers**: Supervised speech classifier extracting 24 acoustic/prosodic parameters (pitch variability, pause ratios, speech cadence, spectral flux) to compute an objective **Voice-derived Mental Health Signal** with in-memory processing (zero raw audio stored).
...
5. **Empathetic AI Companion & Longitudinal History**: Google Gemini companion with strict safety boundaries, milestone timelines, and verified 24/7 Tele-MANAS (14416) crisis escalation.
...
[ 3. Operational Duty Demands & Workload Context ] (WorkloadScreen.jsx)
       │
       ▼
[ 4. Multimodal Voice Check (Optional Acoustic ML) ] (VoiceScreen.jsx)
       │
       ▼
[ 5. Multimodal Decision-Support Dashboard (DSI / TSI / Voice / OSI) ] (AnalysisScreen.jsx)
       ...
       ├─► [ 8. Longitudinal Assessment Milestones Timeline ] (MoodScreen.jsx)
       └─► [ 9. Verified Crisis Intervention ] (Tele-MANAS 14416 / Vandrevala Foundation)
```
...
```powershell
# Run the full automated pytest suite (24 passing tests):
